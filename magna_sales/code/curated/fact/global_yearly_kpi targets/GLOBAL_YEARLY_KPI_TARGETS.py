...
table_name = "FACT_GLOBAL_YEARLY_KPI_TARGETS"
...
df=spark.sql("select * from {}.{}".format(curated_db_name, "GLOBAL_YEARLY_KPI_TARGETS")).select("*")

# COMMAND ----------

# writing data to processed layer before generating surrogate keys
df.write.parquet(processed_location+'GLOBAL_YEARLY_KPI_TARGETS', mode='overwrite')
...
d = surrogate_mapping_hil(csv_data,"FACT_GLOBAL_YEARLY_KPI_TARGETS","GLOBAL_YEARLY_KPI_TARGETS",processed_db_name)

# COMMAND ----------

# writing data to processed layer after generating surrogate keys
d.write.mode('overwrite').parquet(processed_location+"FACT_LOGISTICS_GLOBAL_YEARLY_KPI_TARGETS")

# COMMAND ----------

# inserting log record to last_execution_details to SQL
