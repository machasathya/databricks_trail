...
# Fetching surrogate meta data from SQL
...
# seelcting columns in req order
full_df = spark.sql("select A.CUSTOMER_KEY,A.SECURITY_DEPOSIT, A.SNAPSHOT_DATE_KEY, A.month from sec_dep A")
...
# inserting log record to last_exectuon_details table
