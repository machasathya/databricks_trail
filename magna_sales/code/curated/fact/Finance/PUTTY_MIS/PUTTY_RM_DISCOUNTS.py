...
table_name = "FACT_PUTTY_RM_DISCOUNTS"
...
# writing data to processed layer before generating surroagte keys
final_df.write.parquet(processed_location+'PUTTY_RM_DISCOUNTS', mode='overwrite')
...
d = surrogate_mapping_hil(csv_data,table_name,"PUTTY_RM_DISCOUNTS",processed_db_name)
