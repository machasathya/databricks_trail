...
table_name = "FACT_PF_MIS_TARGET_MASTER"
...
# summing up columns and filtering the months that doesn't have data
...
# adding leading 0's to material code field
final_df = df4.withColumn("MATERIAL_CODE",lpad(col("MATERIAL_CODE"),18,'0'))

# COMMAND ----------

# writing data to processed layer before generating surrogate keys
final_df.write.parquet(processed_location+'PF_MIS_TARGET_MASTER', mode='overwrite')
...
d = surrogate_mapping_hil(csv_data,table_name,"PF_MIS_TARGET_MASTER",processed_db_name)
