...
table_name = "FACT_ASPIRE_GL_BUDGETS"
...
# extracting columns other than month
...
# converting FY and month to starting date of each month
...
final_df.write.parquet(processed_location+'ASPIRE_GL_BUDGETS', mode='overwrite')
...
d = surrogate_mapping_hil(csv_data,table_name,"ASPIRE_GL_BUDGETS",processed_db_name)
