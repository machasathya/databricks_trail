...
final_df = spark.sql("select * from {}.{}".format(curated_db_name,"LSS"))

# COMMAND ----------

# writing data to processed layer before generating surrogate keys
final_df.write.parquet(processed_location+'LSS', mode='overwrite')
...
SBU,
LOCATION,
SMART_LSS_PROJECT_TITLE,
PROJECT_START_DATE,
PROJECT_CLOSURE_DATE,
TOOLS_USED_FOR_PROBLEM_SOLVING,
IMPACT_ON_BUSINESS_LEVER,
PROJECT_THEME,
ANNUALIZED_SAVINGS,
ACCRUED_SAVINGS,
PROJECT_STATUS,
...
d = surrogate_mapping_hil(csv_data,table_name,"LSS",processed_db_name)

# COMMAND ----------

# writing data to processed layer after generating surrogate keys
d.write.parquet(processed_location+'FACT_QUALITY_LSS', mode='overwrite')
