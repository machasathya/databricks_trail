...
table_name = "FACT_QUALITY_PLANT_RLS"
...
# reading group to plant mapping
bi_grps_df=spark.sql("select * from {}.{}".format(curated_db_name, "BI_GROUPS_QUALITY_PLANT")).drop("LAST_UPDATED_DT_TS")

# COMMAND ----------

# defining mail id to plant id mapping
...
rls_final.write.mode('overwrite').parquet(processed_location+"FACT_QUALITY_PLANT_RLS")
