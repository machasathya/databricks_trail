...
# defining class object for processmetadatautility class
...
# refreshing and reading the data from processed layer dimension tables
...
# calculating amount against each customer by replacing nulls with 0's and conveting amount to lakhs
...
# aggregating amount against customer, doc no and item
...
# aggregating data in required columns
...
# flattering territory data by reading it from curated layer
...
# fetching district sales group state zone and country from geo dataframe
...
# writing final cag data to processed layer table
