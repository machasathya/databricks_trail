...
table_name = "FACT_BUYER_WISE_SAVINGS"
...
df = spark.sql("select * from {}.{}".format(curated_db_name,"BUYER_WISE_SAVINGS"))

# COMMAND ----------

# writing data to processed layer before generating surrogate key
df.write.parquet(processed_location+'BUYER_WISE_SAVINGS', mode='overwrite')
...
d = surrogate_mapping_hil(csv_data,table_name,"BUYER_WISE_SAVINGS",processed_db_name)
