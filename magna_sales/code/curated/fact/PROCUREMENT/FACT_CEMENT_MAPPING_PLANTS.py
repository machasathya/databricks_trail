...
table_name = "FACT_CEMENT_MAPPING_PLANTS"
...
df = spark.sql("select * from {}.{}".format(curated_db_name,"CEMENT_MAPPING_PLANTS"))

# COMMAND ----------

# adding leading 0's to vendor id field
final_df = df.withColumn("VENDOR_ID",lpad(col("VENDOR_ID"),10,'0'))

# COMMAND ----------

# writitng data to processed layer before generating surrogate keys
final_df.write.parquet(processed_location+'CEMENT_MAPPING_PLANTS', mode='overwrite')
...
d = surrogate_mapping_hil(csv_data,table_name,"CEMENT_MAPPING_PLANTS",processed_db_name)

# COMMAND ----------

# writitng data to processed layer after generating surrogate keys
