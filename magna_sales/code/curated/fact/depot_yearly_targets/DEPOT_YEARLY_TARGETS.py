...
# Creating object for ProcessMetadataUtility class
pmu = ProcessMetadataUtility()

# COMMAND ----------

# Code to fetch parameters from ADF
...
table_name = "FACT_DEPOT_YEARLY_TARGETS"
...
# from ProcessMetadataUtility import ProcessMetadataUtility
# pmu = ProcessMetadataUtility()
# meta_table = dbutils.widgets.get("meta_table")
# processed_schema_name = dbutils.widgets.get("processed_schema_name")
# schema_name = dbutils.widgets.get("schema_name")
# db_url = dbutils.widgets.get("db_url")
# db = dbutils.widgets.get("db")
...
df=spark.sql("select * from {}.{}".format(curated_db_name, "DEPOT_YEARLY_TARGETS"))

# COMMAND ----------

# Writing data to processed location before generating surrogate keys
df.write.parquet(processed_location+'NET_LOSS_BUDGET', mode='overwrite')

# COMMAND ----------

#SURROGET IMPLEMENTATION
...
d = surrogate_mapping_hil(csv_data,"FACT_DEPOT_YEARLY_TARGETS","NET_LOSS_BUDGET",processed_db_name)

# COMMAND ----------

# Writing data to processed location after generating surrogate keys
d.write.mode('overwrite').parquet(processed_location+"FACT_LOGISTICS_DEPOT_YEARLY_TARGETS")

# COMMAND ----------

# Writing log record to last_execution_details table
